************************************************
Photometric Redshift (PZ) Data Challenge results
************************************************

The Dark Energy Science Collaboration (DESC) invited researchers, data
...
using increasingly realistic data.  Here we present the results.
